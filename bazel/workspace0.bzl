...
def gl_cpp_workspace0(name = None):
    ...
    maybe(
        ...
        urls = [
            "https://github.com/grpc/grpc/archive/v1.70.0-pre1.tar.gz",
        ],
        sha256 = "dae47b98d7d72d6ccc933b5bcc3edf646a6010dcc007d00fa5f02b18383ab796",
        strip_prefix = "grpc-1.70.0-pre1",
    )
